    ...
    def from_data_list(data_list, follow_batch=[]):
        ...
        for i, data in enumerate(data_list):
            for key in data.keys():
                ...
                if key == 'sc_node_to_subgraph':
                    cumsum[key] = cumsum[key] + data.sc_num_subgraphs
                elif key == 'sc_subgraph_to_graph':
                    cumsum[key] = cumsum[key] + 1
                elif key == 'sc_node_index':
                    cumsum[key] = cumsum[key] + data.sc_num_subgraphs
                elif key == 'sc_original_edge_index':
                    cumsum[key] = cumsum[key] + data.sc_num_subgraphs
                elif key == 'sc_edge_index':
                    cumsum[key] = cumsum[key] + data.sc_num_nodes
                    
                elif key == 'fc_node_to_subgraph':
                    cumsum[key] = cumsum[key] + data.fc_num_subgraphs
                elif key == 'fc_subgraph_to_graph':
                    cumsum[key] = cumsum[key] + 1
                elif key == 'fc_node_index':
                    cumsum[key] = cumsum[key] + data.fc_num_subgraphs
                elif key == 'fc_original_edge_index':
                    cumsum[key] = cumsum[key] + data.fc_num_subgraphs
                elif key == 'fc_edge_index':
                    cumsum[key] = cumsum[key] + data.fc_num_nodes
